...
class ProductController(BaseController):
    ...
    def setup_routes(self):
        ...
        self.app.route('/products/delete/<product_id:int>', method=['GET', 'POST'], callback=self.delete_products)
    ...
    def delete_products(self, product_id):
        ...
        product = self.product_service.get_by_id(product_id)
        if request.method == 'GET':
            return self.render('product_delete_form', product=product, action=f'/products/delete/{product_id}')
        else:
